                ...
                async.series([
                            ...
                            function(callback){
                                            ...
                                            if(phonecontacts.length){
                                                    ...
                                                    console.log("----------No Contacts array Found------------------");
                                                    callback();
                                            }
                            },
                            function(callback) {
                                            ...
                                            if(phonecontacts.length){
                                                    ...
                                                    //callback();
                                                        ...
                                                        console.log("----------No Contacts array Found in updation------------------");
                                                        callback();
                                            }
                            },
                            function(callback) {
                            ...
                            function(callback) {
                                            ...
                                            console.log("insertion fb friends---------------")
                                            if(fbUser.length){
                                                    ...
                                                    //FbFriends.create(query, function(err, createdFbFriends) {
                                                        ...
                                                        console.log("----------No Fb array Found in insertion------------------");
                                                        callback();
                                            }
                            },
                            function(callback) {
                                            console.log("-------------------------- SERIES-6 --------------------------");
                                            console.log("updation fb friends ---------------------");
                                            if(fbUser.length){
